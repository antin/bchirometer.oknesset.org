...
(function() {
  ...
  $.widget("mit.agendaSlider", $.extend({}, $.ui.slider.prototype, {
	...
	this.element.append('<button type="button" id="btnWith" class="btn btn-success">(:</button>');
	this.element.append('<button type="button" class="btn btn-default">-</button>');
        this.element.append('<button type="button" class="btn btn-danger">:(</button>');
	this.element.append('<p>');
...
//		alert(value);
    ...
    _refreshValue: function() {
      ...
      if (value < 0) {
	//alert("minus-" + value)
      	this.element.find(".btn btn-default").css({
          height: "40px;",
          width: "38px;"
        });
